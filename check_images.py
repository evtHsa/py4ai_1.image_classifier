...
def main():
    # TXDO 0: Measures total program runtime by collecting start time
    start_time = time()
    
    # TXDO 1: Define get_input_args function within the file get_input_args.py
    ...
    results = get_pet_labels(in_arg_dir)
    ...
    # TXDO 4: Define adjust_results4_isadog function within the file adjust_results4_isadog.py
    ...
    # TXDO 5: Define calculates_results_stats function within the file calculates_results_stats.py
