...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # TXDO: 5a. REPLACE pass with CODE that counts how many pet images of
        ...
        (pet_image_label, classifier_label, labels_match, isa_dog, classifed_as_dog) = results_dic[key]
        if pet_image_label == classifier_label and isa_dog:
        ...
        # TXDO: 5b. REPLACE pass with CODE that counts how many pet images
        ...
        # Pet Image Label is NOT a Dog
            ...
            if not isa_dog and not classified_as_dog:
                n_correct_notdogs
    ...
    # TXDO: 5c. REPLACE zero(0.0) with CODE that calculates the % of correctly
    ...
    # TXDO: 5d. REPLACE zero(0.0) with CODE that calculates the % of correctly
    ...
    # TXDO: 5e. REPLACE zero(0.0) with CODE that calculates the % of correctly
    ...
    # TXDO 5f. REPLACE None with the results_stats_dic dictionary that you
