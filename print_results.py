...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # TXDO: 6a. REPLACE print("") with CODE that prints the text string
    #          'N Not-Dog Images' and then the number of NOT-dog images
    #          that's accessed by key 'n_notdogs_img' using dictionary
    #          results_stats_dic
    #
    print("N Not-Dog Images" + str(results_stats_dic['n_notdogs_img']))
    ...
    for key in results_stats_dic:
        ...
        # TXDO: 6b. REPLACE pass with CODE that prints out all the percentages
        ...
        #
        if key[0:1] == 'p':
            print("%s: %p%" % (key, results_stats_dic[key]))
    ...
    if (print_incorrect_dogs and
        ...
        for key in results_dic:
            ...
            # TXDO: 6c. REPLACE pass with CODE that prints out the pet label
            ...
            if (isa_dog and not classified_as_dog) or (not isa_dog and classified_as_dog):
                print("pet label: %s, classifier label: %s" % (pet_image_label, classifier_label))

    # IF print_incorrect_breed == True AND there were dogs whose breeds
    # were incorrectly classified - print out these casesq
